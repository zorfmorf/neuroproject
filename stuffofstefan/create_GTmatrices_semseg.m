...
save_data = cell(1,12);
for i = 1:12
    load(strcat("GTRUTH\all\raw_data\gtruth_cat",num2str(i),".mat"));
end
...
for k = 1:12
    ...
    for i = 1:N
        name = strcat('GTRUTH\z05w20r10\',cat,...
...
for k=1:12
    save(strcat("GTRUTH\z05w20r15\cat",num2str(k),"\gtruth_z05w20r10_cat",...
